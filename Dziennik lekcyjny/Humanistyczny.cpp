...
void Humanistyczny::wpisz_ocene()
{
	int _rodzaj;
	do
	{
...
void Humanistyczny::wszystkie_oceny(std::ostream& wyjscie)
{
	wyjscie << nazwa << "\n";
	Ocena* tmp = Lista_ocen;
	wyjscie << "Wypracowania: \n";
...
Humanistyczny::Humanistyczny(void)
{
	pNext = nullptr;
}
Humanistyczny::~Humanistyczny()
{
	usun_wszystkie_oceny();
}

bool Humanistyczny::edytuj_ocene()
{
	int _rodzaj;
	do
	{
